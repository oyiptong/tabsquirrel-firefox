...
//TODO: refactor these into module(s)
function TabList(session_id, allowDuplicateUrls) {
  this.tabs = [];
  this.session_id = session_id;
  this.urls = {};
  this.allowDuplicateUrls = allowDuplicateUrls || tsConfig.collect.allowDuplicateTabs;
}
TabList.prototype = {
...
let Application = {
  ...
  openTabsMenu: function A_openTabsMenu() {
    return Task.spawn(function(){
      ...
      //create a TabList session
      let tabList = new TabList(yield this.tabController.createSession());
      ...
      //create the tabs
      yield this.tabController.createTabs(tabList);
